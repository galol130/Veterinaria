...
class UI {
    ...
    imprimirCitas({citas}) {
        ...
        citas.forEach( cita => {
            const { mascota, owner, telefono, fecha, hora, sintomas, id } = cita;
            ...
            ownerParrafo.innerHTML = `
                <span class="font-weight-bolder">Dueño: </span> ${owner}
            `;
...
function nuevaCita(e) {
    ...
    const { mascota, owner, telefono, fecha, hora, sintomas } = citaObj;
